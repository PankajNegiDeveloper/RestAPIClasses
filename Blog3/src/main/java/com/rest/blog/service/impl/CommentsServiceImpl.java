...
public class CommentsServiceImpl implements CommentsService {
	...
	@Autowired
	public CommentsServiceImpl(CommentsRepo commentsRepo, ModelMapper mapper) {
		super();
...
//	}
	...
	// Changing mapDtoToEntity and mapEntityToDto using Modelmapper
	...
	public CommentsDto createComment(CommentsDto commentsDto) {
		Comments comment = commentsRepo.save(mapDtoToEntity(commentsDto));
