...
//		return new ResponseEntity(commentsDto, HttpStatus.CREATED);
		if (postId.equals(commentsDto.getBlogPostId())) {
			CommentsDto createComment = commentsService.createComment(commentsDto);
			return new ResponseEntity(createComment, HttpStatus.CREATED);
		} else {
			return new ResponseEntity("Blog id does not match", HttpStatus.BAD_REQUEST);
		}
	}
	...
	public ResponseEntity<CommentsDto> updateComments(@PathVariable("postId") Integer postId,
